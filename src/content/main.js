...
AniCal.state.urlCheckInterval = setInterval(() => {
...
window.addEventListener('unload', () => {
    AniCal.utils.log("Page unloading - cleaning up intervals");

    // Clear URL check interval
    if (AniCal.state.urlCheckInterval) {
        clearInterval(AniCal.state.urlCheckInterval);
        AniCal.state.urlCheckInterval = null;
    }
